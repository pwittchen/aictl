...
const ALLOWED_CONFIG_KEYS: &[&str] = &[
    ...
    "AICTL_DESKTOP_OPEN_FILE",
    "AICTL_DESKTOP_SIDEBAR_WIDTH",
    "AICTL_DESKTOP_FILES_WIDTH",
    "AICTL_IMAGE_ANALYSIS_PROVIDER",
    "AICTL_IMAGE_ANALYSIS_MODEL",
    "AICTL_IMAGE_GENERATION_PROVIDER",
    "AICTL_IMAGE_GENERATION_MODEL",
    "AICTL_IMAGE_FALLBACK_ENABLED",
    "LLM_OLLAMA_HOST",
    "LLM_OLLAMA_ENABLED",
];
...
fn provider_label(name: &str) -> &'static str {
    match name {
        ...
        "AICTL_CLIENT_MASTER_KEY" => "client",
        "AICTL_SERVER_MASTER_KEY" => "server",
        _ => "",
    }
}
