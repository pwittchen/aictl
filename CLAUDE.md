...
- `read_document` — read a PDF or DOCX file and extract content as markdown text. PDF text extracted via `pdf-extract`; DOCX parsed from the ZIP archive's `word/document.xml` with heading, bold/italic, list, and table conversion to markdown
